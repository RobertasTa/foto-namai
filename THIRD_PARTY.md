...
released — is available at <https://github.com/RobertasTa/foto-namai>.
...
executable must itself be distributed under GPL v3.
...
| [Pillow](https://python-pillow.github.io/) | MIT-CMU (HPND) | Reading and thumbnailing photos |
| [piexif](https://github.com/hMatoba/Piexif) | MIT | Reading EXIF metadata (the true capture date) |
| [pillow-heif](https://github.com/bigcat88/pillow_heif) | BSD-3-Clause (binary wheel: GPLv2, see below) | HEIC support (iPhone photos) |
...
licence) and embeds [CPython](https://www.python.org/) (PSF Licence), including
its bundled [SQLite](https://www.sqlite.org/) (public domain) used for the
photo index.
